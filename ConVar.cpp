...
namespace SourceEngine
{
	...
	public:
		virtual bool RegisterConCommandBase(ConCommandBase *pVar)
		{
			...
			I::pCVar->RegisterConCommand(pVar);
			return true;
		}
	};
	...
	{
		if (!I::pCVar || s_bRegistered)
			return;

		s_bRegistered = true;
		s_nCVarFlag = nCVarFlag;
		s_nDLLIdentifier = I::pCVar->AllocateDLLIdentifier();
	...
	void ConVar_Unregister()
	{
		...
		I::pCVar->UnregisterConCommands(s_nDLLIdentifier);
		s_nDLLIdentifier = -1;
		s_bRegistered = false;
	}
	...
	void ConCommandBase::Create(const char *pName, const char *pHelpString /*= 0*/, int flags /*= 0*/)
	{
		...
		//    Init();
		//}
		I::pCVar->RegisterConCommand(this);
	}
	...
	{
		if (I::pCVar) {
			I::pCVar->UnregisterConCommand(this);
		}
	}
	...
	void ConVar::ChangeStringValue(const char *tempVal, float flOldValue)
	{
		...
		if (I::pCVar)
			I::pCVar->CallGlobalChangeCallbacks(this, pszOldValue, flOldValue);
	}
